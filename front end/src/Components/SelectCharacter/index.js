...
const SelectCharacter = ({ setCharacterNFT }) => {
  ...
  useEffect(() => {
    ...
    if (ethereum) {
      ...
      const gameContract = new ethers.Contract(CONTRACT_ADDRESS, DBZGame.abi, signer);
    ...
    <div className="select-character-container">
      ...
      {mintingCharacter && (
        <div className="loading">
          ...
          <img
            src="https://media3.giphy.com/media/jezZBzIWRItdVgJCMp/giphy.gif?cid=ecf05e47ksj8hodrjwap8sferijfdesoyevouiy4f07tg7jh&rid=giphy.gif&ct=g"
